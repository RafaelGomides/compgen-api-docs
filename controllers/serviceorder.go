...
// URLMapping ...
func (c *ServiceOrderController) URLMapping() {
...
// @Param	body		body 	models.ServiceOrder	true		"body for ServiceOrder content"
// @Success 201 {int} models.ServiceOrder
// @Failure 403 body is empty
// @router / [post]
func (c *ServiceOrderController) Post() {
	var v models.ServiceOrder
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if _, err := models.AddServiceOrder(&v); err == nil {
...
// @Failure 403
// @router / [get]
func (c *ServiceOrderController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllServiceOrder(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *ServiceOrderController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	if err := models.DeleteServiceOrder(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
